      ...
      <div class="modal-card">
        ...
        <form @submit="checkForm" action="#" method="post">
          ...
          <footer class="modal-card-foot">
            ...
            <button v-if="isUserSignedUp" type="button" class="button is-info" @click="createUser">{{ btnRegisteredLabel }}</button>
          </footer>
        </form>
      </div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      repeatPasswordPlaceholder: 'Reepita a senha*',
      notEqualErrorLabel: 'As senhas devem ser iguais',
      passwordErrorLabel: 'Digite sua senha',
      nameErrorLabel: 'Digite seu nome',
      emailErrorLabel: 'Digite seu email',
  ...
  methods: {
    ...
    async createUser ({$axios }){
      
      const postMet = await this.$axios.post('usuario',
      {
        nome:this.name,
        email:this.email,
        senha:this.password,
